...
// Load relay URL from config or environment
function getRelayUrl() {
  // 1. Environment variable takes priority
  if (process.env.CLAWLINK_RELAY_URL) {
    return process.env.CLAWLINK_RELAY_URL;
  }
  
  // 2. Check config file
  const configPath = join(homedir(), '.clawdbot', 'clawlink', 'config.json');
  ...
  // 3. Default to public relay
  return 'https://clawlink-relay.example.com';
}
